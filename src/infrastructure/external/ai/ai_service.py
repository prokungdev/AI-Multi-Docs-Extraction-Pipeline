...
from .cost_estimator import calculate_api_cost
from src.infrastructure.core.constants import DefaultPath, EntityIdPrefix, generate_entity_id
from src.infrastructure.core.telemetry import create_api_call_log, AuditLogService, ApiCallLogCreate
...
class AIService:
    ...
    def extract_with_credentials(
        ...
        """
        Extracts structured JSON with multi-credential rotation.
        """
