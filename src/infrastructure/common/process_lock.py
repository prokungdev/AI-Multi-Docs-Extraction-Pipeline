...
class PipelineProcessLock:
    ...
    def is_process_running(self, pid: int) -> bool:
        ...
        if pid <= 0:
            return False
        try:
            # On Windows & Unix, signal 0 probes process existence without killing it
            os.kill(pid, 0)
            return True
    ...
    def acquire(self) -> bool:
        ...
        Returns True if acquired successfully, False if already locked by another active process.
        """
